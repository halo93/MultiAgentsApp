...
public class SenderAgent_UI extends Agent {
    ...
    public class SendMessage extends CyclicBehaviour {
        ...
        public void action() {
            System.out.println("Please Enter a Message Content");
            String line = null;
            try {
            ...
            if (!line.isEmpty()) {
                ...
                if (line.equals("Hello How Are You?")) {
                    ...
                    System.out.println("I am Going To Kill Myself: Goodbye");
                    this.done();
                }
                else{
                     System.out.println("Message Content is Incorrect: Try a gain");
                     this.done();
                }
            }
        }
